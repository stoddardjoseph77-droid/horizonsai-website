...
// Listens to Cal.com postMessage events for analytics tracking only. The
// /thank-you redirect is handled in CalEmbed via the official cal('on', ...) API.
export default function CalendlyTracker() {
  useEffect(() => {
    ...
    const handler = (event: MessageEvent) => {
      ...
      // Cal emits both bookingSuccessful (v1) and bookingSuccessfulV2 per real
      // booking. Canonical = V2; V1 kept as a separate legacy event so we don't
      // double-count.
